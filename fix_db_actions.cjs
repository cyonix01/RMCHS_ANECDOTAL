...
const regex = /<div className="p-6 space-y-4">[\s\S]*?(?=<div className="p-6 bg-slate-50 border-t border-slate-100 flex justify-end">)/;
...
code = code.replace(regex, databaseActionsContentNew);
